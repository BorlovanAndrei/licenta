...
//   TextField,
//   Button,
//   MenuItem, // Added MenuItem for dropdown selection
// } from "@mui/material";
...
//   useGetTrainersQuery, // Added useGetTrainersQuery
// } from "state/api";
...
//     start: "",
//     end: "",
//     trainerId: "", // Updated to include trainerId
//     description: "",
//   });

//   const { data: classesData, refetch } = useGetClassesQuery();
//   const { data: trainersData } = useGetTrainersQuery(); // Fetch trainers data
...
//     setNewClassData({
//       ...newClassData,
//       trainerId: event.target.value, // Set trainerId when selected
//     });
//   };
...
//             type="datetime-local"
//             fullWidth
//             value={newClassData.start}
//             onChange={(e) =>
//               setNewClassData({ ...newClassData, start: e.target.value })
//             }
//           />
//           <TextField
//             margin="dense"
...
//             type="datetime-local"
//             fullWidth
//             value={newClassData.end}
//             onChange={(e) =>
//               setNewClassData({ ...newClassData, end: e.target.value })
//             }
//           /> */}
